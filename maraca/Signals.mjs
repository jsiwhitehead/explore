...
function Signal(value, isEqual = (a, b) => a === b) {
  this._value = value;
...
Object.defineProperty(Signal.prototype, "value", {
  ...
  set(value) {
    if (!this._isEqual(value, this._value)) {
...
export function signal(value, isEqual) {
...
function Computed(fn, isEqual) {
  Signal.call(this, undefined, isEqual);
  this._fn = fn;
...
Computed.prototype._refresh = function () {
  ...
  try {
    ...
    if (
      ...
      !this._isEqual(this._value, value) ||
      this._version === 0
    ) {
      this._value = value;
      this._flags &= ~HAS_ERROR;
 ...
 */
function computed(fn, isEqual) {
  return new Computed(fn, isEqual);
}
